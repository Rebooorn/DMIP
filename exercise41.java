...
/**
 * Exercise 4-1 of Diagnostic Medical Image Processing (DMIP)
...
public class exercise41 {
	...
	public SimpleVector commonRansac(SimpleMatrix points, int mn, double p_opt, double p_out){
		...
		int it = 2;
		// TODO: calculate the required number
		...
		for(int i = 0; i < it; i++)
		{
			...
			// Calculate the indexes of the points and
			// write them in the ArrayList indexes
	...
	public static void main(String[] args) {
		...
		//
		exercise41 ransac = new exercise41();
